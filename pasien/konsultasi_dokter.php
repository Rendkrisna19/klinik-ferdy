...
<body class="bg-white flex min-h-screen text-gray-800 font-modify">
    ...
    <main class="flex-1 ml-64 p-10">
        <h2 class="text-4xl font-bold mb-6 text-purple-600">Form Konsultasi</h2>

        <?php if ($success): ?>
        <div class="mb-4 p-4 bg-purple-100 text-purple-700 border border-purple-300 rounded-lg shadow">
        ...
        <form action="" method="post"
            class="bg-white p-8 rounded-2xl shadow-xl max-w-xl space-y-6 border border-purple-200">
            <div>
                <label for="dokter_id" class="block mb-2 font-semibold text-gray-700">Pilih Dokter</label>
                <select name="dokter_id" id="dokter_id"
                    class="w-full border border-purple-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-purple-400 focus:outline-none"
                    required>
            ...
            <div class="text-right">
                <button type="submit"
                    class="bg-purple-500 text-white font-semibold px-6 py-2 rounded-lg hover:bg-purple-600 transition">
                    Kirim Konsultasi
                </button>
            </div>
        </form>
